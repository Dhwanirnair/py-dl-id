...
def show_id():
    label_id["text"] = "1234567890"
    label_name["text"] = "Bob Millers"
    label_dob["text"] = "02/02/2022"
    label_pin["text"] = "543210"
    label_address["text"] = "45 Abc rd, Gnome island"
    label_vehicle_type["text"] = "Two Four Twenty"
    
    print("ID:" + label_id + label_name + label_dob + label_pin + label_address + label_type)
    
# Create a button
button1 = Button(root, text = "Show Drivers License", command = show_id)
